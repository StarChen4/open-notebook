    ...
    <AppShell>
      <div className="flex flex-col h-full w-full max-w-none px-6 py-6">
        <div className="mb-6 flex-shrink-0">
          <h1 className="text-3xl font-bold">所有资源</h1>
          <p className="mt-2 text-muted-foreground">
            浏览您所有笔记本中的资源。使用方向键导航，Enter键打开。
          </p>
        </div>
                ...
                <tr>
                  <td colSpan={6} className="h-16 text-center">
                    <div className="flex items-center justify-center">
                      <LoadingSpinner />
                      <span className="ml-2 text-muted-foreground">加载更多资源...</span>
                    </div>
                  </td>
                </tr>
              )}
      ...
      <ConfirmDialog
        ...
        title="删除资源"
        description={`您确定要删除"${deleteDialog.source?.title || '此资源'}"吗？此操作无法撤销。`}
        confirmText="删除"
