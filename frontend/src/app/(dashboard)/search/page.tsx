  ...
  return (
    <AppShell>
      <div className="p-4 md:p-6">
        <h1 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">问答与搜索</h1>
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'ask' | 'search')} className="w-full space-y-6">
          <div className="space-y-2">
            ...
            <TabsList aria-label="问答或搜索您的知识库" className="w-full max-w-xl">
          ...
          <TabsContent value="ask" className="mt-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">向您的知识库提问（测试版）</CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                {!hasEmbeddingModel ? (
                  <div className="flex items-center gap-2 p-3 text-sm text-amber-600 dark:text-amber-500 bg-amber-50 dark:bg-amber-950/20 rounded-md">
                    ...
                    <span>您无法使用此功能，因为您尚未选择嵌入模型。请在模型页面中设置一个。</span>
                  </div>
                ) : (
                  <>
                    <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">按回车键搜索</p>
                </div>
