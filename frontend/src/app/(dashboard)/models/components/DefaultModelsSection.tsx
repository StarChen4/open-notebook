...
const defaultConfigs: DefaultConfig[] = [
  ...
  },
  {
    ...
    label: '工具模型',
    description: '用于函数调用 - 推荐 OpenAI 或 Anthropic',
    modelType: 'language'
  },
  {
    key: 'large_context_model',
    label: '大上下文模型',
    description: '用于处理大型文档 - 推荐 Gemini',
    modelType: 'language'
  },
  {
    key: 'default_embedding_model',
    label: '嵌入模型',
    description: '用于语义搜索和向量嵌入',
    modelType: 'embedding',
    required: true
  },
  {
