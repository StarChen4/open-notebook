...
const navigationItems = [
  { name: '资源', href: '/sources', icon: FileText, keywords: ['files', 'documents', 'upload', 'sources'] },
  { name: '笔记本', href: '/notebooks', icon: Book, keywords: ['notes', 'research', 'projects', 'notebooks'] },
  { name: '提问和搜索', href: '/search', icon: Search, keywords: ['find', 'query', 'ask', 'search'] },
  { name: '播客', href: '/podcasts', icon: Mic, keywords: ['audio', 'episodes', 'generate', 'podcasts'] },
  { name: '模型', href: '/models', icon: Bot, keywords: ['ai', 'llm', 'providers', 'openai', 'anthropic', 'models'] },
  { name: '转换', href: '/transformations', icon: Shuffle, keywords: ['prompts', 'templates', 'actions', 'transformations'] },
  { name: '设置', href: '/settings', icon: Settings, keywords: ['preferences', 'config', 'options', 'settings'] },
  { name: '高级', href: '/advanced', icon: Wrench, keywords: ['debug', 'system', 'tools', 'advanced'] },
]
...
const themeItems = [
  { name: '浅色主题', value: 'light' as const, icon: Sun, keywords: ['bright', 'day', 'light'] },
  { name: '深色主题', value: 'dark' as const, icon: Moon, keywords: ['night', 'dark'] },
  { name: '系统主题', value: 'system' as const, icon: Monitor, keywords: ['auto', 'default', 'system'] },
]
  ...
  return (
    ...
    >
      ...
      <CommandList>
        ...
        {showSearchFirst && (
          <CommandGroup heading="搜索和提问" forceMount>
            <CommandItem
