              ...
              {configInfo && (
                <div className="space-y-2 text-xs text-muted-foreground border-t pt-3">
                  ...
                  <div className="space-y-1 font-mono">
                    ...
                    <div className="break-all">API地址：{configInfo.apiUrl}</div>
                    <div className="break-all">前端：{typeof window !== 'undefined' ? window.location.href : 'N/A'}</div>
                  </div>
